...
export const contactsBlocks: SiteBlock[] = [
	{
		...
		props: {
			...
			people: [
				{ name: 'Алина', role: 'Всё про программу дня', phone: '+7 900 000-00-01', telegram: 'alina' },
				{ name: 'Самат', role: 'Дорога, трансфер, ночёвка', phone: '+7 900 000-00-02', telegram: 'samat' },
