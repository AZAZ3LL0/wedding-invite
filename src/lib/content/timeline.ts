...
export const timelineBlocks: SiteBlock[] = [
	{
		...
		props: {
			...
			entries: [
				...
				{ time: '14:00', title: 'Дорога на площадку', note: 'Автобус от ЗАГСа, места хватит всем.' },
				{ time: '15:00', title: 'Сбор гостей', note: 'Фуршет в саду.', mapUrl: VENUE_MAP },
				{ time: '16:00', title: 'Выездная церемония', note: 'У воды. Если будет дождь, переносим под навес.' },
	...
	},
	{
		...
		props: {
			...
			entries: [
				{ time: '15:00', title: 'Сбор гостей', note: 'Фуршет в саду, тень и вода.', mapUrl: VENUE_MAP },
				{ time: '16:00', title: 'Выездная церемония', note: 'У воды. Если будет дождь, переносим под навес.' },
				{ time: '17:00', title: 'Ужин', note: 'Рассадка по карточкам у входа в зал.' },
				{ time: '20:00', title: 'Танцы', note: 'Живая группа до полуночи, дальше диджей.' },
				{ time: '23:00', title: 'Торт и фейерверк' },
				{ time: '00:30', title: 'Обратный трансфер', note: 'Автобус до города, отмечайтесь в анкете заранее.' }
			]
		}
	}
];
